...
ggplot(data=output2, aes(x=year, y=cases, group=interaction(pfpr, intervention), color=intervention)) + 
  ...
  theme_classic() + 
  annotate("text", x = 18, y = 25000, label = 'PfPR 10') + 
  annotate("text", x = 18, y = 50000, label = 'PfPR 25') + 
  annotate("text", x = 18, y = 60000, label = 'PfPR 35') + 
  annotate("text", x = 18, y = 78000, label = 'PfPR 55') 
